...
namespace CS2013
{
    class ClSousConcentration : ClObjet
    {
        /// <summary>
        ...
        public ClSousConcentration(string p_idConcentration, string p_nomConcentration,
            TypeConcentration p_concentration, int p_objectifCredits,
            TypeUser p_typeUser, string p_idParent)
        {
        ...
        public ClSousConcentration(
            string p_idConcentration,
            string p_nomConcentration,
            int p_objectifCredits)
        {
            IdConcentration = p_idConcentration;
            NomConcentration = p_nomConcentration;
            ObjectifCredits = p_objectifCredits;
        ...
        /// <summary>
        /// L'id de la concentration parent (GUID)
        /// </summary>
        ...
        /// <summary>Le type d'utilisateur</summary>
