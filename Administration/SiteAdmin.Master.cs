...
public partial class SiteAdmin : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        NavigationMenu.Items.Add(new MenuItem("Évenements", "event", "", "~/Pages/Evenement.aspx"));
    ...
    private void SelectionnerPageActive()
    {
        ...
        foreach (MenuItem item in NavigationMenu.Items)
        {
            ...
            if ((Path.GetFileName(item.NavigateUrl).Equals(Path.GetFileName(Request.PhysicalPath),
               ...
               || Path.GetFileName(item.NavigateUrl).Equals("Gestion.aspx") && Path.GetFileName(Request.PhysicalPath).Equals("GestionEvenement.aspx")
               ...
               || Path.GetFileName(item.NavigateUrl).Equals("Gestion.aspx") && Path.GetFileName(Request.PhysicalPath).Equals("Affichage.aspx")
               || Path.GetFileName(item.NavigateUrl).Equals("Gestion.aspx") && Path.GetFileName(Request.PhysicalPath).Equals("GestionAfficheAccueil.aspx")
               || Path.GetFileName(item.NavigateUrl).Equals("Gestion.aspx") && Path.GetFileName(Request.PhysicalPath).Equals("GestionLogoCegep.aspx")
               || Path.GetFileName(item.NavigateUrl).Equals("Gestion.aspx") && Path.GetFileName(Request.PhysicalPath).Equals("GestionPhotosBougeotte.aspx")
