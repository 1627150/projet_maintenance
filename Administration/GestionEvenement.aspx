<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GestionEvenement.aspx.cs" Inherits="CS2013.GestionEvenement" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Gestion des <i>Évenements</i>.</h2>
    <br />
    <p>*Un évenement ajoutée à une date future sera affichée à cette date.</p>
    ...
    <asp:UpdatePanel ID="updateCapsules" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="GridEvenement" runat="Server" AutoGenerateColumns="False" BackColor="White" AllowSorting="True" AllowPaging="True" PageSize="10"
